...
# openfire-spring-boot-starter

**Spring Boot Starter for openfire**

[![Maven Central](https://img.shields.io/maven-central/v/io.github.easy4j/openfire-spring-boot-starter)](https://github.com/easy-4-java/openfire-spring-boot-starter)
...
> **Artifact ID**：`openfire-spring-boot-starter`<br>
> **License**：Apache License 2.0<br>

## 1. Positioning

**openfire-spring-boot-starter** is a Spring Boot starter that integrates **openfire** for applications using openfire. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume openfire capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using openfire |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for openfire |
| JDK | `17` |
| Coordinates | `io.github.easy4j:openfire-spring-boot-starter:3.2.x.20260527-SNAPSHOT` |
| Config Prefix | `openfire` |

## 2. Core Capabilities

| Capability | Status | Description |
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers openfire beans automatically |
| Property Binding | ✅ Stable | Binds `openfire.*` to `OpenfireProperties` |
| Ready-to-use beans | ✅ Stable | Auto-registered via OpenfireAutoConfiguration |
...
<dependency>
    ...
    <artifactId>openfire-spring-boot-starter</artifactId>
...
|---|---|---|:---:|---|:---:|
| `openfire.enabled` | boolean | `true` | No | Enable the starter | No |
...
```bash
mvn clean verify
mvn -pl openfire-spring-boot-starter -am test
```
...
|---|---|---|
| Bean not created | Check auto-configuration report | Verify `openfire.enabled=true` and classpath |
...
[Back to top](#readme-top) · [Issues](https://github.com/easy-4-java/openfire-spring-boot-starter/issues) · [Repository](https://github.com/easy-4-java/openfire-spring-boot-starter)
